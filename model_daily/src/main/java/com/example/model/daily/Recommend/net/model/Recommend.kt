    ...
    data class Item(
        ...
        data class Data(
            ...
            data class Consumption(
                ...
                val collectionCount: Int, // 84898
                @SerializedName("realCollectionCount")
                val realCollectionCount: Int, // 17461
            ...
            data class Content(
                ...
                data class Data(
                    ...
                    data class Consumption(
                        @SerializedName("collectionCount")
                        val collectionCount: Int, // 146731
                        @SerializedName("realCollectionCount")
                        val realCollectionCount: Int, // 26078
                        @SerializedName("replyCount")
                        val replyCount: Int, // 1289
                        @SerializedName("shareCount")
                        val shareCount: Int // 265600
                    )
